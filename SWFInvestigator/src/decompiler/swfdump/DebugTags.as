...
package decompiler.swfdump
{
	public class DebugTags
	{
		...
		// Breakpoint info
		public static const kDebugScript:int = 0;
		public static const kDebugOffset:int = 1;
		public static const kDebugBreakpoint:int = 2;
		public static const kDebugID:int = 3;
		// --Recycle Bin (2/7/03 9:52 AM): public static final int kDebugTree = 4;
		public static const kDebugRegisters:int = 5;
